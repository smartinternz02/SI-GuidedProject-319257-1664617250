...
API_KEY = "Q7V_YkwLv_ljzhDgzlg1cbRA5CDBB3H-2SaDW7-ba2FK"
...
def pred():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/fa6160cb-d2ea-46cc-a24c-30f1f6135c61/predictions?version=2022-10-30', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
